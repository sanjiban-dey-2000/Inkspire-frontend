...
const Blog = () => {
  ...
  const posts = [
    { id: 1, title: "Building Scalable Web Apps with React and Node.js", description: "Learn the key architectural decisions and performance optimizations for full-stack scalability.", image: "nodeReact.webp", tag: "Development" },
    ...
    { id: 3, title: "JavaScript ES2025 Features You Should Know", description: "Explore the upcoming changes that make JavaScript more powerful and developer-friendly.", image: "js.png", tag: "JavaScript" },
    ...
    { id: 7, title: "Mastering React in 2025", description: "A complete guide to building high-performance web apps using React and Tailwind CSS.", image: "react.webp", tag: "Development" },
    { id: 8, title: "Backend Brilliance: Node.js & Express", description: "Learn how to build scalable APIs and microservices using Node.js and Express.", image: "node.jpg", tag: "Development" },
    { id: 9, title: "Clean Code: Writing for the Future", description: "Why writing readable, maintainable code is more valuable than writing clever code.", image: "cleanCode.webp", tag: "Development" },
    ...
    { id: 11, title: "Understanding Large Language Models", description: "A simplified guide to how GPT-style models think, learn, and generate text.", image: "LLM.webp", tag: "AI" },
    { id: 12, title: "Ethics in the Age of AI", description: "Exploring the ethical challenges and moral responsibilities of building intelligent machines.", image: "Ethics.webp", tag: "AI" },
